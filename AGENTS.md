...
panel. The FastAPI control plane remains the only backend boundary.
...
- `VITE_API_BASE`: public backend URL only; never place secrets in frontend env. Local default is `http://127.0.0.1:8767`.
